...
def check():
    ...
    for one_file_path in all_files:
        ...
        try:
            ...
            result_polarity = recomm.test_polarity()
            result_rating = recomm.test_rating()
            
            print 'rating: ',result_rating,'\t','polarity: ',result_polarity

            Result_Log.write('rating: '+str(result_rating)+'\t'+'polarity: '+str(result_polarity))
